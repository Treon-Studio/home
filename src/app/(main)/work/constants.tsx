...
export const filters = ['all', 'products', 'community', 'services'] as const;
...
export const projects: Project[] = [
  ...
  {
    type: 'project',
    title: 'Trenzo - Market Research Platform',
    slug: 'trenzo',
    preview: SupabaseHomepagePreview,
    images: [SupabaseHomepage01, SupabaseHomepage02, SupabaseHomepage03],
    filters: ['products'],
    description:
      'Market research platform for e-commerce sellers. Analyze trends across Shopee, Tokopedia, and TikTok Shop. Get insights on product performance, competitor analysis, and market opportunities to grow your online business.',
    link: 'https://treonstudio.com',
    tags: ['Next.js', 'React', 'Data Analytics'],
    aspect: 0.9,
  },
  {
    type: 'project',
    title: 'Investrack - Investment Communication Platform',
    slug: 'investrack',
    preview: LiveKitPreview,
    images: [LiveKit01, LiveKit02, LiveKit03, LiveKit04],
    filters: ['products'],
    description:
      'Investment communication platform connecting investors with project owners. Streamline your investor relations with real-time updates, document sharing, and transparent communication channels.',
    link: 'https://treonstudio.com',
    tags: ['Next.js', 'Real-time', 'Communication'],
    aspect: 1.1,
  },
  {
    type: 'project',
    title: 'Munaqadh - Donation Campaign Platform',
    slug: 'munaqadh',
    preview: EchoTabLandingPreview,
    images: [EchoTabLanding01, EchoTabLanding02],
    filters: ['products'],
    description:
      'Donation campaign and charitable giving platform. Create and manage donation campaigns with transparent fund tracking, donor management, and impact reporting features.',
    link: 'https://treonstudio.com',
    tags: ['Next.js', 'Payment Integration', 'Social Impact'],
    aspect: 1.0,
  },
  ...
  {
    type: 'project',
    title: 'Kopod - Digital Professional Podcast',
    slug: 'kopod',
    preview: DorsclucPreview,
    images: [DorsclucPreview1, DorsclucPreview2],
    filters: ['community'],
    description:
      'Podcast amplifying stories of digital professionals. Listen to inspiring journeys, insights, and experiences from tech professionals across Indonesia and beyond.',
    link: 'https://treonstudio.com',
    tags: ['Podcast', 'Community', 'Tech Stories'],
    aspect: 0.9,
  },
  {
    type: 'project',
    title: 'Radas - Developer Toolkit',
    slug: 'radas',
    preview: SketchbookPreview,
    images: [Sketchbook01, Sketchbook02, Sketchbook02a, Sketchbook03],
    filters: ['community'],
    description:
      'Developer toolkit for frontend, backend, and DevOps teams. A curated collection of tools, resources, and utilities to boost your development workflow.',
    link: 'https://treonstudio.com',
  ...
  {
    type: 'project',
    title: 'Muslimfy - Islamic Lifestyle App',
    slug: 'muslimfy',
    preview: BukaBrandingPreview,
    images: [BukaBranding01, BukaWeb],
    filters: ['community'],
    description:
      'App integrating Islamic principles with modern technology. Features include prayer times, Quran reading, Islamic calendar, and daily reminders to support your spiritual journey.',
    link: 'https://treonstudio.com',
    tags: ['Mobile App', 'Islamic', 'Lifestyle'],
    aspect: 0.8,
  },
  ...
  // Services Showcase
  {
    ...
    images: [SupabaseLW1201, SupabaseLW1202, SupabaseLW1203, SupabaseLW1204],
    filters: ['services'],
    description:
      'Professional web development services starting from $60/month. Responsive design, CMS integration, SEO optimization, and modern web technologies to bring your vision to life.',
    link: 'https://treonstudio.com',
  ...
  },
  {
    ...
    filters: ['services'],
    description:
      'iOS and Android development services starting from $180/month. Cross-platform compatibility, native performance, and user-centered design for mobile applications.',
    link: 'https://treonstudio.com',
  ...
  },
  {
    ...
    images: [SupabaseIcons00, SupabaseIconsGif, SupabaseIcons01, SupabaseIcons02],
    filters: ['services'],
    description:
      'Comprehensive design system services starting from $306/month. Component libraries, brand guidelines, documentation, and design tokens for consistent user experiences.',
    link: 'https://treonstudio.com',
