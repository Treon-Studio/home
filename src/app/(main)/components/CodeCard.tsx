...
const directoryData: DirectoryItem[] = [
  {
    name: 'treonstudio',
    githubUrl: 'https://github.com/treonstudio',
    children: [
      {
        name: 'radas',
        githubUrl: 'https://github.com/treonstudio/radas',
        children: [
          {
            name: 'platform-tools',
            githubUrl: 'https://github.com/treonstudio/radas',
      ...
      {
        name: 'kopod',
        githubUrl: 'https://github.com/treonstudio/kopod',
        children: [
          {
            name: 'podcast',
            githubUrl: 'https://github.com/treonstudio/kopod',
      ...
      {
        name: 'muslimfy',
        githubUrl: 'https://github.com/treonstudio/muslimfy',
        children: [
          {
            name: 'chrome-ext',
            githubUrl: 'https://github.com/treonstudio/muslimfy',
...
export function TreeView({ data, className }: TreeViewProps) {
  return (
    <div className={cn('max-h-[280px] overflow-y-auto text-sm', className)}>
...
function TreeNode({ item, level, parentName }: TreeNodeProps) {
  ...
  // Special indentation for radas children
  const isDeepNested = parentName === 'radas';
