...
import { calculatePosition } from '~/src/utils/calculate-position';
import { parsePathToVertices } from '~/src/utils/svg-path-to-vertices';
  ...
  (
    ...
    const registerElement = useCallback(
      (id: string, element: HTMLElement, props: MatterBodyProps) => {
        ...
        const { chamfer: _chamfer, ...safeOptions } = props.matterBodyOptions || {};
        const bodyOptions = { ...safeOptions, angle, render: renderOptions };
    ...
    return (
      <GravityContext.Provider value={{ registerElement, unregisterElement }}>
        <div ref={canvas} className={cn(className, 'absolute top-0 left-0 h-full w-full')} {...props}>
          {children}
        </div>
