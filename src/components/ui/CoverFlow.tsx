...
export function CoverFlow({
  ...
  return (
    ...
    >
      ...
      <div className="absolute left-0 right-0 flex flex-col items-center justify-center pointer-events-none z-40 transition-opacity duration-300" style={{ top: `calc(50% + ${itemHeight / 2 + 24}px)` }}>
        <motion.div
